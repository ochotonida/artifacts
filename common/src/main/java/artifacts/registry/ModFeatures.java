...
public class ModFeatures {
    ...
    public static final RegistrySupplier<Feature<NoneFeatureConfiguration>> CAMPSITE = artifacts.registry.RegistrySupplier.of(FEATURES.register("campsite", CampsiteFeature::new));
