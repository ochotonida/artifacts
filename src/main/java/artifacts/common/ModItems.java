...
public class ModItems {
    ...
    public static final BaubleBase SHINY_RED_BALLOON = new BaublePotionEffect("shiny_red_balloon", BaubleType.RING, MobEffects.JUMP_BOOST, 1).setEquipSound(SoundEvents.ENTITY_ITEM_PICKUP, 0.5F);
    ...
    public static final BaubleBase POWER_GLOVE = new BaubleBase("power_glove", BaubleType.RING);
